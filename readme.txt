...
Contributors: biztechc,dharmeshthakor
...
5. Selected comment type option will displaying all its comments(Single or with replies).
...
== Changelog ==
= 5.1.0 =
* Compatibility with word-press : 6.4.3
* Compatibility with php : 8.2
* Fixed bug, vulnerability and php warnings .
* updated code to wordpress coding standards .
* Added data escaping and also updated data sanitization .
* Fixed: vulnerable to SQL Injection
* Fixed: vulnerable to Cross Site Scripting (XSS)
= 5.0.4 =
* Compatibility with word-press : 6.2
